        ...
        return args -> {
            ...
            if (runInitData && repository.count() == 0) {
                ...
                TourPackageEntity p1 = TourPackageEntity.builder()
                        ...
                        .startDate(LocalDateTime.of(2026, 7, 20, 8, 0))
                        .endDate(LocalDateTime.of(2026, 7, 25, 18, 0))
                        .duration(5)
                ...
                TourPackageEntity p2 = TourPackageEntity.builder()
                        ...
                        .startDate(LocalDateTime.of(2026, 7, 21, 9, 0))
                        .endDate(LocalDateTime.of(2026, 7, 26, 18, 0))
                        .duration(5)
                ...
                TourPackageEntity p3 = TourPackageEntity.builder()
                        ...
                        .startDate(LocalDateTime.of(2026, 8, 1, 10, 0))
                        .endDate(LocalDateTime.of(2026, 8, 6, 18, 0))
                        .duration(5)
